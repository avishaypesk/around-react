class Api {
  ...
  updateUserInfo = ({ name, about }) =>
    this._fetch({ url: "users/me", method: "PATCH", data: { name, about } });

  updateUserImage = (avatar) =>
    this._fetch({ url: "users/me/avatar", method: "PATCH", data: { avatar } });

  submitNewCard = ({ name, link }) =>
    this._fetch({ url: "cards", method: "POST", data: { name, link } });
